...
def _m101_write_calibration_qa(calibrations, images, output_name, log):
    ...
    calibration_fields += ['g_global_ON', 'free_g_QA_ON', 'z_source_fit_ON', 'delta_illumination_ON',
                           ...
                           'source_fraction_ON', 'G_threshold_ON_0p03', 'G_threshold_ON_0p05',
                           'G_threshold_ON_0p10', 'valid_G_ON',
                           ...
                           'source_fraction_OFF', 'G_threshold_OFF_0p03', 'G_threshold_OFF_0p05',
                           'G_threshold_OFF_0p10', 'valid_G_OFF',
