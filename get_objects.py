...
if 'gc' in inst:
    ...
    print('TARFILE: EXP TARGET QPROG EXPTIME REXPTIME PEXPTIME DARKTIME QRA QDEC DATE')
        ...
        if 'hpf' in inst:
            ...
            if name[-5:] == '.fits':
                ...
                try:
                    ...
                    ra = '00:00:00'
                    dec = '+00:00:00'
                print('%s: %s  %s  %s %0.1f %0.1f %0.1f %0.1f %s %s %s' % (tarfolder, name[-8:-5],
                                                Target, prog, exptime, rexptime, pexptime, dexptime, ra, dec, dt))
                flag = False
    T.close()